...
void test_VectorLength(void) {
    struct Vector * vec = VectorInit(sizeof(int), 10, 100, 0);
...
void test_VectorsAreEqual_DifferentElementSz(void)
{
   struct Vector * vec1 = VectorInit(sizeof(uint8_t), 10, 100, 0);
   struct Vector * vec2 = VectorInit(sizeof(float), 10, 100, 0);
...
void test_VectorsAreEqual_DifferentLength(void)
{
   struct Vector * vec1 = VectorInit(sizeof(int), 10, 100, 0);
   struct Vector * vec2 = VectorInit(sizeof(int), 10, 100, 0);
...
void test_VectorsAreEqual_DifferentCapacity(void)
{
   struct Vector * vec1 = VectorInit(sizeof(int), 5, 100, 0);
   struct Vector * vec2 = VectorInit(sizeof(int), 10, 100, 0);
...
void test_VectorsAreEqual_DifferentMaxCapacity(void)
{
   struct Vector * vec1 = VectorInit(sizeof(int), 10, 50, 0);
   struct Vector * vec2 = VectorInit(sizeof(int), 10, 100, 0);
...
void test_VectorSplitAt_ValidIdx_StructData(void)
{
   ...
   struct Vector * vec = VectorInit(sizeof(struct MyData_S), 10, 100, 0);
...
void test_VectorConcatenate_BasicUse(void)
{
   struct Vector * v1 = VectorInit(sizeof(int), 5, 10, 0);
   struct Vector * v2 = VectorInit(sizeof(int), 5, 10, 0);
   int vals1[] = {1, 2, 3};
   int vals2[] = {4, 5};
...
void test_VectorConcatenate_FullVectors(void)
{
   struct Vector * v1 = VectorInit(sizeof(int), 3, 3, 0);
   struct Vector * v2 = VectorInit(sizeof(int), 2, 2, 0);
   int vals1[] = {1, 2, 3};
   int vals2[] = {4, 5};
   for (size_t i = 0; i < 3; i++) VectorPush(v1, &vals1[i]);
   for (size_t i = 0; i < 2; i++) VectorPush(v2, &vals2[i]);
...
void test_VectorConcatenate_NullArguments(void)
{
   struct Vector * v1 = VectorInit(sizeof(int), 2, 2, 0);
...
{
   struct Vector * v1 = VectorInit(sizeof(int), 2, 2, 0);
   struct Vector * v2 = VectorInit(sizeof(double), 2, 2, 0);
...
void test_VectorSubRange_PushElements_ValidInts(void)
{
   struct Vector * vec = VectorInit(sizeof(int), 5, 10, 0);
   int data[] = {1, 2, 3};
...
void test_VectorSubRange_PushElements_ValidStructs(void)
{
   ...
   struct Vector * vec = VectorInit(sizeof(struct MyData_S), 2, 10, 0);
...
void test_VectorSubRange_PushElements_ExpandCapacity(void)
{
   struct Vector * vec = VectorInit(sizeof(int), 2, 10, 0);
   int data[] = {1, 2, 3, 4};
...
void test_VectorSubRange_PushElements_ExceedsMaxCapacity(void)
{
   struct Vector * vec = VectorInit(sizeof(int), 2, 4, 0);
   int data[] = {1, 2, 3, 4, 5};
...
void test_VectorSubRange_InsertElementsAt_ValidStructs(void)
{
   ...
   struct Vector * vec = VectorInit(sizeof(struct MyData_S), 4, 10, 0);
...
void test_VectorSubRange_InsertElementsAt_ExactlyMaxCapacity(void)
{
   struct Vector * vec = VectorInit(sizeof(int), 2, 5, 0);
...
void test_VectorSubRange_InsertElementsAt_Push_Equivalence(void)
{
   struct Vector * vecpush = VectorInit(sizeof(int), 5, 10, 0);
   struct Vector * vecinsert = VectorInit(sizeof(int), 5, 10, 0);
